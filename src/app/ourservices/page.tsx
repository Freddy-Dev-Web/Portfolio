...
const PageServices = () => {
  return (
    <>
    <div className='pt-20 pb-10 px-15 lg:px-10'>
    <div className='flex justify-between  pb-40 lg:pb-30 pt-40'>
      {/* Left Section */}
      <div className='leading-8'>
        <h1 className='text-5xl lg:text-3xl text-bold pb-10 '>Our Services</h1>
        <p className='text-[18px] lg:text-[15px]'>
      ...
      <div className='leading-8'>
        ...
        <h2 className='font-serif text-bold text-3xl lg:text-2xl pb-8'>Dream it.</h2>
        <p className='text-[18px] lg:text-[15px]'>
        ...
        <section className='pb-25'>
        <h2 className='font-serif text-bold text-3xl lg:text-2xl pb-8'>Build it.</h2>
        <p className='text-[18px] lg:text-[15px]'>
        ...
        <section>
        <h2 className='font-serif text-bold text-3xl lg-2xl pb-8'>Grow it.</h2>
        <p className='text-[18px] lg:text-[15px]'>
        It all begins with an idea. Maybe you want to launch a <br /> business. Maybe you want to turn a hobby into something <br /> more. Or maybe you have a creative project to share with <br /> the world. Whatever it is, the way you tell your story online can <br /> make all the difference.
        </p>
        </section>
